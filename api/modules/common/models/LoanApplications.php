...
class LoanApplications extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'assigned_dealer' => 'Assigned Dealer',
            'rc_number' => 'Rc Number',
            ...
            'roi' => 'Roi',
            'pf' => 'Pf',
            'number_of_emis' => 'Number Of Emis',
            'emi_collection_date' => 'Emi Collection Date',
            'intake' => 'Intake',
            'td' => 'Td',
            ...
            'registry_status_updated_on' => 'Registry Status Updated On',
            'registry_status_updated_by' => 'Registry Status Updated By',
