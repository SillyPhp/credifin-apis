...
/**
 * This is the model class for table "{{%organization_labels}}".
 *
 ...
 * @property string $organization_enc_id Relation with org table
 ...
 */
class OrganizationLabels extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
