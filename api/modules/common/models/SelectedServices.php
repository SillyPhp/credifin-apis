 ...
 * @property string $assigned_user By which User assigned
...
class SelectedServices extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['selected_service_enc_id', 'service_enc_id', 'organization_enc_id', 'assigned_user', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
            ...
            [['assigned_user'], 'exist', 'skipOnError' => true, 'targetClass' => Users::className(), 'targetAttribute' => ['assigned_user' => 'user_enc_id']],
        ];
    }
    ...
    {
        return $this->hasOne(Users::className(), ['user_enc_id' => 'assigned_user']);
    }
