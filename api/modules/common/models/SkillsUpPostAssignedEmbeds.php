...
/**
 * This is the model class for table "{{%skills_up_post_assigned_embeds}}".
 *
 * @property int $id Primary Key
 * @property string $assigned_enc_id Post Encrypted ID
 * @property string $embed_enc_id
 ...
 * @property SkillsUpEmbedPosts $embedEnc
 */
class SkillsUpPostAssignedEmbeds extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%skills_up_post_assigned_embeds}}';
    }
    ...
    {
        return [
            [['assigned_enc_id', 'embed_enc_id', 'post_enc_id', 'created_by'], 'required'],
            [['created_on', 'last_updated_on'], 'safe'],
            [['assigned_enc_id', 'embed_enc_id', 'post_enc_id', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
            ...
            [['embed_enc_id'], 'exist', 'skipOnError' => true, 'targetClass' => SkillsUpEmbedPosts::className(), 'targetAttribute' => ['embed_enc_id' => 'embed_enc_id']],
        ];
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getEmbedEnc()
    {
        return $this->hasOne(SkillsUpEmbedPosts::className(), ['embed_enc_id' => 'embed_enc_id']);
    }
}
