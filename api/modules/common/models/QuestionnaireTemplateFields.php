...
/**
 * This is the model class for table "{{%questionnaire_template_fields}}".
 *
 ...
 * @property string $questionnaire_enc_id Foreign Key to Questionnaire Templates
 ...
 */
class QuestionnaireTemplateFields extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%questionnaire_template_fields}}';
    }
    ...
    {
        return $this->hasMany(QuestionnaireTemplateFieldOptions::className(), ['field_enc_id' => 'field_enc_id']);
    }
