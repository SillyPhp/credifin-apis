...
class AssignedDealerBrands extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['assigned_dealer_brands_enc_id', 'assigned_dealer_enc_id', 'financer_vehicle_brand_enc_id', 'created_by', 'updated_on', 'updated_by'], 'required'],
            [['created_on', 'updated_on'], 'safe'],
            [['is_deleted'], 'integer'],
            [['assigned_dealer_brands_enc_id', 'assigned_dealer_enc_id', 'financer_vehicle_brand_enc_id', 'created_by', 'updated_by'], 'string', 'max' => 100],
