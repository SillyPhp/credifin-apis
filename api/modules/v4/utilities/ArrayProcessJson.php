...
class ArrayProcessJson
{
    public static function Parse($list){
        foreach ($list as $key => $lst){
            ...
            $list[$key]['SMAO']['collected_verified_amount'] = $lst['collected_verified_amount_SMA0'];
            ...
            $list[$key]['SMA1']['collected_verified_amount'] = $lst['collected_verified_amount_SMA1'];
            ...
            $list[$key]['SMA2']['collected_verified_amount'] = $lst['collected_verified_amount_SMA2'];
            ...
            $list[$key]['NPA']['collected_verified_amount'] = $lst['collected_verified_amount_NPA'];
            ...
            $list[$key]['OnTime']['collected_verified_amount'] = $lst['collected_verified_amount_OnTime'];
