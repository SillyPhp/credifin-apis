...
class CandhomeController extends ApiBaseController{
    ...
    public function actionCounts($id){
    ...
    public function actionAppliedApplications($id){
...
//        return $this->response(200, $q);
    ...
    public function actionFollowedCompanies($id){
