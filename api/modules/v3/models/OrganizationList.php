...
class OrganizationList
{
    ...
    public function getList($l = 6, $o = 0, $id)
    {
        $data = (new \yii\db\Query())
            ...
            ->select(['a.organization_enc_id', 'COUNT(distinct c.application_enc_id) total_applications', 'b.business_activity', 'a.initials_color', 'a.name', 'a.slug', 'CASE WHEN a.logo IS NOT NULL THEN CONCAT("' . Url::to(Yii::$app->params->digitalOcean->organizations->logo) . '", a.logo_location, "/", a.logo) ELSE NULL END logo'])
