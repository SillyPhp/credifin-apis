    ...
    public function actionFeatured()
    {
        if (Yii::$app->request->isAjax) {
            ...
            $organizations = \common\models\Organizations::find()
                ->select(['initials_color color', 'CONCAT("/", slug) link', 'name', 'CASE WHEN logo IS NOT NULL THEN CONCAT("' . Url::to(Yii::$app->params->digitalOcean->organizations->logo) . '", logo_location, "/", logo) ELSE NULL END logo'])
