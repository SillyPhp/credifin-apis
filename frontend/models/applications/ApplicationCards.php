...
class ApplicationCards
{
        ...
        $cards1 = (new \yii\db\Query())
            ...
            ->select(['a.source',
               ...
               END) as experience', 'a.organization_enc_id', 'a.unclaimed_organization_enc_id',
                ...
                'CASE WHEN d.logo IS NOT NULL THEN CONCAT("' . Url::to(Yii::$app->params->digitalOcean->organizations->logo) . '", d.logo_location, "/", d.logo) ELSE NULL END logo',
        ...
        $cards2 = (new \yii\db\Query())
            ...
            ->select(['a.source',
               ...
               END) as experience', 'a.organization_enc_id', 'a.unclaimed_organization_enc_id',
                ...
                'REPLACE(d.name, "&amp;", "&") as organization_name',
                'CASE WHEN d.logo IS NOT NULL THEN CONCAT("' . Url::to(Yii::$app->params->digitalOcean->unclaimedOrganizations->logo) . '", d.logo_location, "/", d.logo) ELSE NULL END logo',
                '(CASE
    ...
    public static function InstitutesCards($options = [])
    {
        $cards = (new \yii\db\Query())
            ...
            ->select(['name', 'initials_color', 'a.slug', 'CASE WHEN a.logo IS NOT NULL THEN CONCAT("' . Url::to(Yii::$app->params->digitalOcean->organizations->logo) . '", a.logo_location, "/", a.logo) ELSE NULL END image', 'b.business_activity'])
