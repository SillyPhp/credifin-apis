        ...
        <div class="col-md-12">
            <div class="container">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="bg-color">
                        <img src="<?= Url::to('@eyAssets/images/usajobs/Students & recent graduates1.png'); ?>" class="img_load">
                        <h3> Students & recent graduates  </h3>
                    </div>

                </div>
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <p class="paragraph">If you’re a current student or recent graduate, you may be eligible for federal internships and job opportunities through the Pathways and other student programs.  </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
           <h3 class="st-btn"> Internship Program</h3>
            <div class="para">
                ...
                <p><a href="#">Learn more about the Internship Program <i class="fas fa-external-link-alt"></i></a> </P>
                ...
                <p><a href="#">Learn more about the recent graduate program  <i class="fas fa-external-link-alt"></i></a> </P>
    ...
    <div class="row"  >
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="paragraph">
                ...
                <p>In the job announcement look for the This job is open to section. When a job is open to Students you’ll see the Students icon: . When a job is open to Recent graduates, you'll see the Recent graduates icon: . There may be other groups listed that can also apply.  </p>
                <p>You can also select the Students or recent graduates filter. Your results will display all jobs open to students and recent graduates. </p>
            </div>
