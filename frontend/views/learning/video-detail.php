            ...
            <div class="col-md-7 white-bg">
                <div class="row">
                    ...
                    <div class="video-details">
                        <div class="v-title"><?= $video_detail['name'];?></div>
                        <div class="v-category">
                            <ul>
                                <li>Category: <span><a href=""> <?= $video_detail['category'];?> </a></span></li>
                                <?php
                                if($video_detail['sub_category']){
                                    ?>
                                    <li id="subcate">Sub Category: <span><a href=""> <?= $video_detail['sub_category']; ?></a></span></li>
                                    <?php
                                }
                                ?>
                            </ul>
                        ...
                        <div class="v-tags">
                            <ul>
                                <?php
                                $tags = explode(',',$video_detail['tags']);
                                foreach ($tags as $tag) {
                                    ?>
                                    <a href="">
                                        <li> <?=ucwords($tag)?></li>
...
<?php
echo $this->render('/widgets/mustache/skills/related-videos');
echo $this->render('/widgets/mustache/skills/interested-topics-card');
echo $this->render('/widgets/mustache/skills/top-videos-card');
echo $this->render('/widgets/mustache/skills/top-category-card');
$this->registerCss('
.footer{
