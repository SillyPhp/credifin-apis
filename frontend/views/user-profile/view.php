                ...
                <div class="left-side-container">
                    ...
                    <div class="header-details">
                        ...
                        if ($user['user_enc_id'] === Yii::$app->user->identity->user_enc_id) {
                            ?>
                            <a href="/<?= Yii::$app->user->identity->username; ?>/edit" class="edit-profile-btn"
                               target="_blank">Edit Profile</a>
                            <?php
                            if (!empty($userCv)) {
                                $cv = Yii::$app->params->upload_directories->resume . $userCv['resume_location'] . DIRECTORY_SEPARATOR . $userCv['resume'];
                                ?>
