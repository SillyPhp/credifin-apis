<?php
$this->title = Yii::t('frontend', 'Volunteer Application');
...
$(document).on('submit', '#volunteer-application-from', function(event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    form.firstform = $('#volunteer-application-from').serialize(); 
    $('.tab_1').hide();
    $('.tab_2').show();
});
$(document).on('submit','#volunteer-apply-form', function(event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status == 200) {
                ...
                $("#volunteer-application-from")[0].reset();
                $("#volunteer-apply-form")[0].reset();
            } else {
