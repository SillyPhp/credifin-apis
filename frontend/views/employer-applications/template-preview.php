...
$slug = $org['slug'];
$org = Yii::$app->user->identity->organization;
        ...
        <div class="row m-0">
                ...
                <div class="job-single-sec">
                    ...
                    <div class="job-details">
                        ...
                        $this->render('/widgets/employer_applications/working-days', [
                            'working_days' => $data['applicationOptionsTemplates']['working_days']
                        ]);
                        ?>
                        <?=
                        ...
                        $this->render('/widgets/employer_applications/job-description', [
                            'job_description' => $data['applicationTemplateJobDescriptions'],
                            'type' => $type,
                        ]);
                        ?>
                        ...
                        $this->render('/widgets/employer_applications/educational-requirements', [
                            'educational_requirements' => $data['applicationEduReqTemplates'],
                        ]);
                        ?>
                        <?php
                        if (!empty($data['applicationSkillsTemplates'])):
                            echo $this->render('/widgets/employer_applications/skills', [
                                'skills' => $data['applicationSkillsTemplates'],
                            ]);
                        endif;
                        ?>
                        <?=
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 z-index-9">
                ...
                echo $this->render('/widgets/employer_applications/organization-details', [
                    ...
                    'org_name' => $org['name'],
                    'initial_color' => $org['initials_color'],
                    'slug' => $org['slug'],
                    'website' => $org['website'],
                    'type' => $type,
