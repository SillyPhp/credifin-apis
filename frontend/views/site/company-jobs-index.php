                ...
                <div class="col-md-12">
                    <div class="header-content">
                        <div class="vertically-center">
                            ...
                            <div class="main-bttn">
                                <a href="/signup/organization" class="button2">Create job
                ...
                <div class="col-lg-12">
                    ...
                    <div class="how-to-sec">
                        <div class="how-to animatable fadeIn">
                            ...
                            <h3>Create and Post Jobs</h3>
                            <p>Create a Job, get applications, let candidates fill Questionnaire.
...
$this->registerCss('
.header{
    background:url(' . Url::to('@eyAssets/images/pages/index2/com-jobs-bg.png') . ');
