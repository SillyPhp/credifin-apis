...
$image = Url::to('@eyAssets/images/pages/education-loans/loan-application.png', 'https');
$this->title = "Apply for Loan Online at Low Interest Rate";
$keywords = "education loan, personal loan, home loan, gold loan, vehicle loan, business loan, loan against property, student loan, low-interest loan";
...
?>
    ...
    <section class="admission-form">
        <div class="oa-container">
            ...
            <div class="flex-main">
                <div class="left-sec">
                    <p class="il-heading">Apply for loan by<br> filling out simple details and get your<br> <span
                                class="colorOrange">loan process initiated with our financing partners</span>
                    </p>
                </div>
                <div class="right-sec">
                    <div class="ls-box-shadow">
                        ...
                        <?= $form->field($model, 'applicantName', ['template' => '{input}{error}'])->textInput(['placeholder' => 'Applicant Name'])->label(false); ?>
                        <div class="form-group">
                            <p>Loan Type</p>
                            <div class="radio-toolbar">
                                <?= $form->field($model, 'loanType')->inline()->radioList([
                        ...
                        <div class="form-flex">
                            ...
                            <div class="form-group ml5">
                                <?= $form->field($model, 'loanPurpose', ['template' => '{input}{error}'])->textInput(['placeholder' => 'Loan Purpose'])->label(false); ?>
                            </div>
                        </div>
                        <?= $form->field($model, 'current_city', ['template' => '{input}{error}'])->textInput(['placeholder' => 'Current City Name'])->label(false); ?>
                        <div class="form-flex">
                            <div class="form-group mr5">
...
$('#contact').mask("#", {reverse: true});
  ...
  $(document).on('submit', '#loanApplicationForm', function (event) {
  ...
  function _razoPay(ptoken,payment_enc_id,loan_app_enc_id){
    var options = {
    "key": access_key, 
    "name": "Empower Youth",
    ...
    "handler": function (response){
        updateStatus(payment_enc_id,loan_app_enc_id,response.razorpay_payment_id,"captured",response.razorpay_signature);
                swal({
                        title: "",
    ...
    "theme": {
     ...
     rzp1.on('payment.failed', function (response){
        updateStatus(payment_enc_id,loan_app_enc_id,null,"failed");
      swal({
      title:"Error",
