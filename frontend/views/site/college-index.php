        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="get-started-btn">
                    <button type="button" class="button-gradient" id="collegeSignupModal">Get Started Now</button>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="service-buttons">
                    ...
                    <div class="ser-box">
                        ...
                        <p class="serBttn">Campus Internship Placement<p>
                    </div>
                    <div class="ser-box">
...
<!-- The Modal -->
<div id="myModal" class="collegeSignUpmodal">
                    ...
                    <div class="uname">
                        <div class="form-group field-username required">
                            <input type="text" id="collegeName" class="uname-in" name="collegeName" autofocus=""
                                   autocomplete="off" placeholder="College Name" aria-required="true">
                            <p class="help-block help-block-error"></p>
                        </div>
                    </div>
                    <div class="uname">
                        <div class="form-group field-username required">
                            <input type="text" id="position" class="uname-in" name="position" autofocus=""
                                   autocomplete="off" placeholder="Position" aria-required="true">
                            <p class="help-block help-block-error"></p>
                        </div>
                    </div>
...
<script>
    ...
    var btn = document.getElementById("collegeSignupModal");
