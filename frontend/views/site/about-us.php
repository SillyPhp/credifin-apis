...
<section class="divider parallax layer-overlay overlay-theme-colored-9"
         data-bg-img="<?= Url::to('@eyAssets/images/backgrounds/bg3.png'); ?>" data-parallax-ratio="0.7">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h6 class="letter-space-4 text-white text-uppercase mb-0"></h6>
                <h2 id="visionh" class="text-white text-uppercase mb-0 text-center">
                    <b><?= Yii::t('frontend', 'Vision of ' . Yii::$app->params->site_name); ?></b></h2>
    ...
    <div class="container">
        ...
        <div class="row swp">
            <div class="col-md-6 col-sm-6">
                <img src="<?= Url::to('@eyAssets/images/pages/about-us/employment.png'); ?>"
                     alt="<?= Yii::t('frontend', 'Employment'); ?>">
            </div>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <img class="abtt" src="<?= Url::to('@eyAssets/images/pages/about-us/engagement.png'); ?>"
                     alt="<?= Yii::t('frontend', 'Engagement'); ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <img src="<?= Url::to('@eyAssets/images/pages/about-us/exposure.png'); ?>"
                     alt="<?= Yii::t('frontend', 'Exposure'); ?>">
            </div>
            <div class="col-md-6 col-sm-6">
                <h6 class="letter-space-4 text-gray-darkgray text-uppercase mt-0 mb-0"></h6>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <img src="<?= Url::to('@eyAssets/images/pages/about-us/empowerment.png'); ?>"
                     alt="<?= Yii::t('frontend', 'Empowerment'); ?>">
            </div>
        </div>
        <section>
            <div class="row">
