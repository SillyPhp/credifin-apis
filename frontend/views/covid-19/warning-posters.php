                            ...
                            <div class="bg-shadow">
                                <div class="small-img" id="posterThumb">
                                    <div class="small-icons">
                                        <img src="<?= Url::to('@eyAssets/images/pages/safety-posters/handSanitizer.png') ?>">
                                    </div>
                                    <div class="small-icons">
                                        <img src="<?= Url::to('@eyAssets/images/pages/safety-posters/handSanitizerOne.png') ?>">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="covid-list" id="safetyList">
                    ...
                    <ul class="topicLists">
                        <li class="liClick activeLi" id="sanitizer">
                            ...
                            <span>2</span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/handSanitizer.png') ?>"
                                  class="data-img"></span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/handSanitizerOne.png') ?>"
                                  class="data-img"></span>
                        </li>
                        <li class="liClick" id="distance">Please maintain physical distance<span>2</span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/physicalDistance.png') ?>"
                                  class="data-img"></span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/physicalDistanceOne.png') ?>"
                                  class="data-img"></span>
                        </li>
                        <li class="liClick" id="masksRequired">Masks required beyond this point<span>2</span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/masksRequired.png') ?>"
                                  class="data-img"></span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/masksRequiredOne.png') ?>"
                                  class="data-img"></span>
                        </li>
                        <li class="liClick" id="glovesMasks">Gloves & masks required beyond this point<span>2</span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/glovesMasks.png') ?>"
                                  class="data-img"></span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/glovesMasksOne.png') ?>"
                                  class="data-img"></span>
                        </li>
                        <li class="liClick" id="social">Thanks for practicing social distancing<span>2</span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/socialDistance.png') ?>"
                                  class="data-img"></span>
                            <span data-img="<?= Url::to('@eyAssets/images/pages/safety-posters/socialDistanceOne.png') ?>"
                                  class="data-img"></span>
                        </li>
...
.safety-header{
    background: url(' . Url::to('@eyAssets/images/pages/safety-posters/safetyHeaderOne.png') . ');
...
.safety-bg{
    background: url(' . Url::to('@eyAssets/images/pages/safety-posters/speakers-bg.png') . ');
