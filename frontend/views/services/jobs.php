        ...
        <div class="row">
            <div class="col-md-12 text-center text-white">
                ...
                <div class="search-by-type">
                    <form class="form-inline" action="<?= Url::to('/service/searched-results?'); ?>">
    ...
    <section>
        <div class="container">
            <nav class="nav1 cl-effect-18 nav-second-bg" id="cl-effect-18">
                <div class="container">
                    <a href="/site/walk-in-interview" data-hover="Desultory">Walk in Interview</a>
                    <a href="/site/explore-company" data-hover="Sumptuous">Explore Company</a>
                    <a href="/site/jobs-near-me" data-hover="Scintilla">Jobs Near Me</a>
                    <a href="/site/start-up-jobs" data-hover="Propinquity">Start Up Jobs</a>
                </div>
            </nav>
            <div class="row mt-20">
                    ...
                    for ($j = 0; $j < 4; $j++) {
                        if ($next < $total_categories) {
                            ...
                            <div class="col-md-3 col-sm-6 categories">
                                <a href="<?= Url::to('/jobs/job-list-related?r=' . $job_categories[$next]['slug']); ?>">
                                    <figure class="grids">
...
<section  class="bck">
    <div class="container text-center">
        <h3 class="search-job">The easiest way to get your new job.</h3>
        <nav class=" nav2 nav1 cl-effect-2" id="cl-effect-2">
            <div class="nav2text">Search&nbsp; Job By </div>
            <a href="/service/searched-results?type=location"><span data-hover="LOCATION">LOCATION</span></a>
            <a href="/service/searched-results?type=role"><span data-hover="ROLE">ROLE</span></a>
            <a href="/service/searched-results?type=industry"><span data-hover="INDUSTRY">INDUSTRY</span></a>
        </nav>
    </div>
</section>
