...
?>
        ...
        <div class="container">
            <div class="col-md-6 col-sm-6">
                <div class="loan-text">
                    ...
                    <h3>We Work With You To Turn Your Dreams Into Reality</h3>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="loan-image">
                    <!--                    <img src="--><?//= Url::to('@eyAssets/images/pages/educational-loans/loan.png') ?><!--"/>-->
                </div>
            </div>
        </div>
    </section>
    <section class="edu-with-sec">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3 categories">
                    <figure class="grids">
    ...
    <section class="edu-loan">
        <div class="container">
            ...
            <div class="col-md-6"><a href="/site/education-loan" class="hvr-sweep-to-bottom">Apply Now</a></div>
        </div>
    </section>
    <div class="clearfix"></div>
                    ...
                    <div class="col-md-2">
                        <div class="lp-box">
                            <div class="lp-details">
                                ...
                                <div class="lp-name">Citizen Bank</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
    ...
    <section>
        <div class="container">
            <div class="col-md-12">
                <h3 class="heading-style"><?= Yii::t('frontend', 'Partner Colleges'); ?></h3>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="college-box">
                        <div class="cb-logo">
                            <img src="<?= Url::to('@eyAssets/images/pages/company-and-candidate/gna-university.png') ?>" alt="">
                        </div>
                        <div class="cb-name">GNA University</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="college-box">
                        ...
                        <div class="cb-name">Guru Nanak Institute Of Management and Technology</div>
                    </div>
                </div>
            </div>
        </div>
...
.backgrounds{
    ...
    background-image: url(' . Url::to('@eyAssets/images/pages/educational-loans/ed-loan.png') . ');
...
.edu-loan{ 
    background: url(' . Url::to('@eyAssets/images/pages/educational-loans/bg2.png') . '); 
    background-repeat:no-repeat;
