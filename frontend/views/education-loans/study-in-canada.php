...
$this->title = 'Study in Canada';
$keywords = 'Study in Canada | Empower Youth';
$description = 'Do not let financial burden stop you from fulfilling your desire to study in your dream college.';
$image = Url::to('@eyAssets/images/pages/education-loans/study-in-canada.png', 'https');
...
<!--    <div class="opacity-div"></div>-->
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-sm-12 col-xs-12">
                ...
                <h1>
                    <span class="typewrite" data-period="2000"
                          data-type='["Study In CANADA.", "Education Loan.", "Easy Apply.", "Easy EMIs To Pay.", "Less Paperwork." ]'>
            ...
            <div class="col-md-7">
                <div class="canada-vector">
                    <img src="<?= Url::to('@eyAssets/images/pages/education-loans/study-in-canada-vctr.png') ?>">
                </div>
            </div>
        </div>
    </div>
...
<section class="studyus-head">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7">
                <h3 class="heading-style">Why Study In Canada?</h3>
                <p class="why-des">Canada is well known in the world for the standard of education that it maintains while educating its students.
                    The educators in the Canadian colleges/universities are well trained and educated.
                    They teach their students with the help of the latest technology and different perspectives that builds the overall personality of the students exceptionally.
                    Moreover, the students who moved to Canada for their further studies enjoy a high standard of living.</p>
                <div class="row">
...
<section class="bg-blue">
    <?php $is_show = 0; ?>
    <?= $this->render('/widgets/choose-education-loan',['is_show'=>$is_show]) ?>
</section>
...
.study-in-usa-bg {
	background: url(' . Url::to('@eyAssets/images/pages/education-loans/study-in-canada-bg.png') . ');
