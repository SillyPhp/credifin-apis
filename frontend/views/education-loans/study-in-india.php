    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 tac">
                <div class="whystudy">
                    <img src="<?= Url::to('@eyAssets/images/pages/custom/india.png')?>" alt="">
                </div>
            </div>
            <div class="col-md-7">
                <h3 class="heading-style">Why Study In India?</h3>
                <p class="why-des">India is land of diverse cultures, traditions and languages.
                    Its unique and well recognized education system makes it a must
                    choice for many students. There are many places for students to explore
                    while studying which makes it a great experience for them. It has a wide variety of courses in many fields like Computer, Philosophy and Politics.
                    India's higher education system has 575 university-level institutions for students to select from.</p>
                <div class="row">
