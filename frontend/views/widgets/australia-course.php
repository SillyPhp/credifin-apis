                ...
                <div class="col-md-6">
                    <div class="egov-job">
                        <a href="/education-loans/apply">
                            ...
                            <h1 class="link-none">Australia STEM Prime </h1>
                            <p class="link-sub-head">Education Financing to fulfil your aspirations</p>
                            <div class="gj-text gj-blue">
                                <ul>
                                    <li>Covering 10 esteemed colleges in <br>
                                        Australia offering STEM programs</li>
                                    <li>Unsecured Loan Limit Up to ₹30 Lac*</li>
                ...
                <div class="col-md-6">
                    <div class="egov-job">
                        <a href="/education-loans/apply">
                            ...
                            <h1 class="link-none">Australia STEM Advanced</h1>
                            <p class="link-sub-head">Education Financing to fulfil your aspirations</p>
