    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="detail-div">
                ...
                <p>We ensure 100% transparency throughout the teacher loan process. Our team will stay by your side at every step of the whole process.</p>
            </div>
        </div>
            ...
            <ul>
                <li>
                    <div class="clickedItem rightElem"
                         data-value="Through Empower Youth, expect to get teacher loans with the least amount of collateral. Our strategic partnerships with some of the most popular lenders enable us to provide teachers with personal loans with almost free collateral."
                ...
                <li>
                    <div class="clickedItem rightElem"
                         data-value="Expect 24/7 assistance from Empower Youth in case of any problem. Our counsellors boast years of experience in finance and will provide free of cost assistance to you."
                ...
                <li>
                    <div class="clickedItem rightElem"
                         data-value="At Empower Youth, we deeply value convenience and reliability. Our all loans are 100% secure and sourced from the safest banks and NBFCs."
            ...
            <ul>
                <li>
                    <div class="clickedItem ciActive"
                         data-value="We ensure 100% transparency throughout the teacher loan process. Our team will stay by your side at every step of the whole process.We ensure 100% transparency throughout the teacher loan process. Our team will stay by your side at every step of the whole process.We ensure 100% transparency throughout the teacher loan process. Our team will stay by your side at every step of the whole process."
