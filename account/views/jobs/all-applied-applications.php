                ...
                $app_type = strtolower($app_type_link);
                    ...
                    <div class="jobsBoxes">
                        <div class="row">
                            <div class="col-md-10">
                                <h3 class="job-title">
                                    <?= $app_type_link . ': '.'<a class="url-forward" href="javascript:;" data-id="/'. $app_type .'/'. $fields['slug'].'" target="_blank">' . $fields['job_title'].'</a>'?>
                                </h3>
                            </div>
                        </div>
                        <?php
                                ...
                                <div class="row pr-user-main">
                                    <div class="reject-box" <?= (($arr['rejection_window'] == 1) ? 'style="display: flex;"' : '') ?>>
                                        <div class="pr-top-actions text-right">
                                            <a class="url-forward" data-id="<?= Url::to($arr['username'] . '?id=' . $arr['applied_application_enc_id'], true) ?>" href="#"
                                               target="_blank">View
                                                Profile</a>
                                            <?php
                                                ...
                                                if($arr['candidateRejections'][0]['candidateConsiderJobs']){
                                                    ...
                                                    <div class="sr-jobs">
                                                        ...
                                                        foreach ($arr['candidateRejections'][0]['candidateConsiderJobs'] as $crj) {
                                                            ...
                                                            ?>
                                                            <a class="url-forward" data-id="/<?= $app_type ."/". $crj['applicationEnc']['slug']?>" href="#" target="_blank">
                                      ...
                                      <span class="past-title">
                                        ...
                                        <div class="col-md-3 pl-0">
                                            <div class="pr-user-actions">
                                                <div class="pr-top-actions text-right">
                                                    <a href="#" data-id="<?= Url::to($arr['username'] . '?id=' . $arr['applied_application_enc_id'], true) ?>"
                                                      class="url-forward" target="_blank">View
                                                        Profile</a>
                                                    <?php
