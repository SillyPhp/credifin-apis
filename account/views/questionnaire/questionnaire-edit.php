                    ...
                    <div class="portlet-body field-selections">
                        <nav class="questionnaire-feilds">
                            <ul class="nav">
                                ...
                                <li>
                                    <div class="q-btns">  <?= Html::submitButton('Update', ['class' => 'btn blue btn-circle submit btn-block']); ?></div>
                                </li>
                                <li>
