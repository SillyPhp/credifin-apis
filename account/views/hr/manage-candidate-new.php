                ...
                <div class="portlet-body">
                    <div class="tab-content">
                                    ...
                                    <div class="row cd-box">
                                        <div class="col-md-3 cd-can-box">
                                            <div class="cd-box-border col-md-12">
                                                ...
                                                <div class="cd-btns">
                                                    <div class="col-md-6 bttn-cd"> 
                                                        <a href="/account/hr/hr-candidates" class="btn orange">View</a>
                                                    </div>   
                                                    <div class="col-md-6 bttn-cd">
                                                        <button type="button" class="btn blue">Shortlist</button>   
                                                    </div>    
                                                </div>  
                                            </div>                     
                                        </div>                      
                        ...
                        <div class="com-load-more-btn">
                            <button type="button" id="comloadmore" class="btn custom-buttons blue">Load More</button>
                        </div>
                    </div>
                </div>
            </div>
...
.cd-box-border:hover{
    -o-box-shadow:0 0 20px rgb(0,0,0,.1); 
    -ms-box-shadow:0 0 20px rgb(0,0,0,.1); 
