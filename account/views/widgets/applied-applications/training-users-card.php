                            ...
                            <div class="mt-action-img" style="width: auto">
                                <a href="/<?= $candiates['username'] ?>">
                                    <?php if (!empty($candiates['image_location']) && !empty($candiates['image'])) { ?>
                                        <?php $user_img = Yii::$app->params->digitalOcean->users->image . $candiates['image_location'] . DIRECTORY_SEPARATOR . $candiates['image']; ?>
                                ...
                                <div class="mt-action-row">
                                    ...
                                    <div class="mt-action-buttons">
                                        <div class="btn-group btn-group-circle">
                                            <a href="/<?= $candiates['username'] ?>" target="_blank" class="btn btn-outline green btn-sm">View Profile</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
