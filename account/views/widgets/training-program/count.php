        ...
        <div class="jobs_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?= $applications['total']; ?>"><?= $applications['total']; ?></span>
                </div>
            </div>
        </div>
    </a>
    ...
    <a href="<?= Url::to('/account/interview-processes'); ?>">
        <div class="processes_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?= $interview_processes['total']; ?>"><?= $interview_processes['total']; ?></span>
                </div>
            </div>
        </div>
    </a>
    ...
    <a href="<?= Url::to('/account/questionnaire'); ?>">
        <div class="questionnaire_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?= $questionnaire['total']; ?>"><?= $questionnaire['total']; ?></span>
                </div>
            </div>
        </div>
    </a>
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 employees_count">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    ...
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?= $applied_applications['total']; ?>"><?= $applications['total']; ?></span>
                </div>
            </div>
        </div>
    </a>
