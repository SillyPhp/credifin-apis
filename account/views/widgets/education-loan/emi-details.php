<?php
$payable_interest = ($data['loanSanctionReports'][0]['loan_amount'] / 100 * $data['loanSanctionReports'][0]['rate_of_interest']);
$total_payment = (int)$payable_interest + (int)$data['loanSanctionReports'][0]['loan_amount'] + (int)$data['loanSanctionReports'][0]['processing_fee'];
$emi_structures = $data['loanSanctionReports'][0]['loanEmiStructures'];
?>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="loanName"><?= $data['loan_type'] . ' for ' . $data['applicant_name'] ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-sm-4 text-sm-left borderRight">
                            <div class="statsBox">
                                ...
                                <h3 class="mt10"><span><i
                                                class="fa fa-inr"></i></span> <?= money_format('%!i', $total_payment) ?>
                                </h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 text-sm-left borderRight">
                            <div class="statsBox">
                                ...
                                <h3 class="mt10"><span><i
                                                class="fa fa-inr"></i></span> <?= money_format('%!i', $payable_interest) ?>
                                    <span><?= $data['loanSanctionReports'][0]['rate_of_interest'] ?>%</span></h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 text-sm-left borderRight">
                            <div class="statsBox">
                                ...
                                <h3 class="mt10"><span><i
                                                class="fa fa-inr"></i></span> <?= money_format('%!i', $data['loanSanctionReports'][0]['loan_amount']); ?>
                                </h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-6 text-sm-left borderRight">
                            <div class="statsBox">
                                ...
                                <h3 class="mt10"><span><i
                                                class="fa fa-inr"></i></span> <?= money_format('%!i', $data['loanSanctionReports'][0]['processing_fee']); ?>
                                </h3>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="emiTable">
                                        ...
                                        foreach ($emi_structures as $emi) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <i class="fa fa-inr"></i> <?= money_format('%!i', $emi['amount']) ?>
                                                </td>
                                                <td>
                                                    <i class="fa fa-inr"></i> <?= money_format('%!i', $balanceAmount) ?>
                                                </td>
                                            </tr>
                                            <?php
                                        }
