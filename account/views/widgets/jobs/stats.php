...
?>
    ...
    <div class="col-md-3 col-sm-6">
        <a href="<?= Url::toRoute('/jobs'); ?>">
            <div class="jobs_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 nd-shadow total-jobs">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="<?= Url::toRoute('/hiring-processes'); ?>">
            <div class="processes_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 nd-shadow total-int-p">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="<?= Url::toRoute('/questionnaire'); ?>">
            <div class="questionnaire_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 nd-shadow total-qn">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="<?= Url::toRoute('/jobs'); ?>">
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 employees_count nd-shadow total-appl">
