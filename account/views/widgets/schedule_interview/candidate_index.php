                ...
                <div class="events-wrapper">
                    <div class="events">
                        <ol>
                            ...
                            <li>
                                <a href="#0" id="test_pest" data-date="03/03/2015"
                                   class="border-after-red bg-after-red">3 Mar - 1</a>
                            </li>
                        </ol>
...
<?php
$this->registerJsFile('@backendAssets/global/plugins/horizontal-timeline/horizontal-timeline.js', ['depends' => [\yii\bootstrap\BootstrapAsset::className()]]);