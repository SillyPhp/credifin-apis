...
?>
    ...
    <div class="col-md-3">
        <a href="<?= Url::toRoute('/internships'); ?>">
            <div class="internships_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 nd-shadow total-intern">
    ...
    <div class="col-md-3">
        <a href="<?= Url::toRoute('/hiring-processes'); ?>">
            <div class="processes_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 nd-shadow total-inter">
    ...
    <div class="col-md-3">
        <a href="<?= Url::toRoute('/questionnaire'); ?>">
            <div class="questionnaire_count widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 nd-shadow total-qne">
                <h4 class="widget-thumb-heading"><?= Yii::t('account', 'Total Questionnaire'); ?></h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon fa fa-question"></i>
                    <div class="widget-thumb-body">
                    <span class="widget-thumb-body-stat" data-counter="counterup"
    ...
    <div class="col-md-3">
        <a href="<?= Url::toRoute('/internships'); ?>">
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 employees_count nd-shadow total-apply">
