    ...
    $('#calendar').fullCalendar({
        ...
        eventClick: function (calEvent, jsEvent, view) {
            ...
            $.each(calEvent.time , function (index) {
                    if(calEvent.time[index].date == calEvent.start._i){
                        $.each(calEvent.time[index].time , function (underindex) {
                            $("#time_slots").append(GetOption(calEvent.time[index].time[underindex].from,calEvent.time[index].time[underindex].to, calEvent.time[index].time[underindex].interview_date_timing_enc_id));
                        });
                    }
                });
            $('#myModal').modal();
