...
<div class="wrapper">
    <div class="wrapper-inner" style=" background-image:url('<?= Url::to('@commonAssets/email_service/thank-you/bg-pattren.png', 'https') ?>');">
        <div class="thankyou-box">
            <div class="">
                <img src="<?= Url::to('@commonAssets/email_service/e_campus_logo.png', true) ?>">
            </div>
    ...
    <div class="social-links">
        <ul>
            <li><a href="https://www.facebook.com/MY-E-Campus-101163728174771/?modal=admin_todo_tour">
                    <img src="<?= Url::to('@commonAssets/email_service/thank-you/icon-fb.png', true);?>">
                </a></li>
            <li><a href="https://www.instagram.com/my_e_campus/">
                    <img src="<?= Url::to('@commonAssets/email_service/thank-you/icon-insta.png', true);?>">
                </a></li>
            <li><a href="https://twitter.com/my_ecampus">
                    <img src="<?= Url::to('@commonAssets/email_service/thank-you/icon-twitter.png', true);?>">
                </a></li>
            <li><a href="https://www.linkedin.com/company/my-ecampus/about/?viewAsMember=true">
