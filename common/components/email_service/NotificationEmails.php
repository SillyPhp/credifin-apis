    ...
    public function webinarRegistrationEmail($params){
        $data = Webinar::find()
            ...
            ->select(['a.webinar_enc_id',
                'CASE WHEN a.email_sharing_image IS NOT NULL THEN CONCAT("' . Url::to(Yii::$app->params->digitalOcean->baseUrl . Yii::$app->params->digitalOcean->rootDirectory .DIRECTORY_SEPARATOR. Yii::$app->params->upload_directories->webinars->banners->image, 'https') . '", a.email_sharing_image_location, "/", a.email_sharing_image) END image',
