...
class FinancerLoanProductPurpose extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['financer_loan_product_purpose_enc_id', 'financer_loan_product_login_fee_structure_enc_id', 'purpose', 'sequence', 'created_by'], 'required'],
            [['sequence', 'is_deleted'], 'integer'],
            [['created_on', 'updated_on'], 'safe'],
            [['financer_loan_product_purpose_enc_id', 'financer_loan_product_login_fee_structure_enc_id', 'created_by', 'updated_by'], 'string', 'max' => 100],
