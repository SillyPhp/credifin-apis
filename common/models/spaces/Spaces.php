...
namespace common\models\spaces;
...
class Space
{
    ...
    */
    ...
    public  function uploadFileMeta($filePath, $saveAs = "", $privacy = "private", $metaData = [])
    {
        if (empty($saveAs))
        {
            $saveAs = $filePath;
        ...
        $content = fopen($filePath, "r");
        $result = $this->s3->upload($this->name, $saveAs, $content, $privacy, $metaData);
