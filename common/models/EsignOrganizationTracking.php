...
class EsignOrganizationTracking extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['esign_tracking_enc_id', 'organization_enc_id', 'legality_document_id', 'empower_loans_tracking_id', 'created_by'], 'required'],
            [['created_on', 'updated_on'], 'safe'],
            [['esign_tracking_enc_id', 'organization_enc_id', 'legality_document_id', 'empower_loans_tracking_id', 'created_by', 'updated_by'], 'string', 'max' => 100],
