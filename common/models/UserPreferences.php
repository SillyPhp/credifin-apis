...
class UserPreferences extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['preference_enc_id', 'job_profile', 'type', 'timings_from', 'timings_to', 'min_expected_salary', 'max_expected_salary', 'experience', 'working_days', 'created_on', 'created_by'], 'required'],
            [['type', 'experience', 'sat_frequency', 'sun_frequency'], 'string'],
