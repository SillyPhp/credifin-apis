...
class VehicleRepossession extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['vehicle_repossession_enc_id', 'loan_account_enc_id', 'vehicle_model', 'km_driven', 'current_market_value', 'repossession_date', 'created_by', 'updated_on', 'updated_by'], 'required'],
            [['km_driven', 'current_market_value'], 'number'],
            [['insurance', 'rc', 'is_deleted'], 'integer'],
            [['repossession_date', 'created_on', 'updated_on'], 'safe'],
            [['vehicle_repossession_enc_id', 'loan_account_enc_id', 'vehicle_model', 'registration_number', 'created_by', 'updated_by'], 'string', 'max' => 100],
