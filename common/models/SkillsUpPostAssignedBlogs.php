...
/**
 * This is the model class for table "{{%skills_up_post_assigned_blogs}}".
 *
 * @property int $id Primary Key
 * @property string $assigned_enc_id Post Encrypted ID
 * @property string $blog_post_enc_id
 ...
 * @property Posts $blogPostEnc
 */
class SkillsUpPostAssignedBlogs extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%skills_up_post_assigned_blogs}}';
    }
    ...
    {
        return [
            [['assigned_enc_id', 'blog_post_enc_id', 'post_enc_id', 'created_by'], 'required'],
            [['created_on', 'last_updated_on'], 'safe'],
            [['assigned_enc_id', 'blog_post_enc_id', 'post_enc_id', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
            ...
            [['blog_post_enc_id'], 'exist', 'skipOnError' => true, 'targetClass' => Posts::className(), 'targetAttribute' => ['blog_post_enc_id' => 'post_enc_id']],
        ];
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getBlogPostEnc()
    {
        return $this->hasOne(Posts::className(), ['post_enc_id' => 'blog_post_enc_id']);
    }
}
