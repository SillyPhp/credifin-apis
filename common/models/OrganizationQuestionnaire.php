 ...
 * @property QuestionnaireTemplates $templateEnc
...
class OrganizationQuestionnaire extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['questionnaire_enc_id', 'questionnaire_name', 'questionnaire_for', 'organization_enc_id', 'created_by'], 'required'],
            [['created_on', 'last_updated_on'], 'safe'],
            [['is_deleted'], 'integer'],
            [['questionnaire_enc_id', 'questionnaire_name', 'organization_enc_id', 'template_enc_id', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
            [['questionnaire_for'], 'string', 'max' => 15],
            [['questionnaire_enc_id'], 'unique'],
            [['organization_enc_id'], 'exist', 'skipOnError' => true, 'targetClass' => Organizations::className(), 'targetAttribute' => ['organization_enc_id' => 'organization_enc_id']],
            [['template_enc_id'], 'exist', 'skipOnError' => true, 'targetClass' => QuestionnaireTemplates::className(), 'targetAttribute' => ['template_enc_id' => 'questionnaire_enc_id']],
    ...
    {
        return $this->hasOne(QuestionnaireTemplates::className(), ['questionnaire_enc_id' => 'template_enc_id']);
    }
