...
/**
 * This is the model class for table "{{%application_template_job_description}}".
 *
 ...
 */
class ApplicationTemplateJobDescription extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%application_template_job_description}}';
    }
