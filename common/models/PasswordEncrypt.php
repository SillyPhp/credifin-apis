...
class PasswordEncrypt extends Model {

    public $PASSWORD_BCRYPT = 1;
    public $PASSWORD_DEFAULT = PASSWORD_BCRYPT;
    public $PASSWORD_BCRYPT_DEFAULT_COST = 10;
    ...
    function password_hash($password, $algo, array $options = array()) {
        ...
        $resultLength = 0;
        switch ($algo) {
            case $this->PASSWORD_BCRYPT:
                $cost = $this->PASSWORD_BCRYPT_DEFAULT_COST;
    ...
    function password_get_info($hash) {
        ...
        if (_substr($hash, 0, 4) == '$2y$' && _strlen($hash) == 60) {
            $return['algo'] = $this->PASSWORD_BCRYPT;
    ...
    function password_needs_rehash($hash, $algo, array $options = array()) {
        ...
        switch ($algo) {
            case $this->PASSWORD_BCRYPT:
                $cost = isset($options['cost']) ? (int) $options['cost'] : $this->PASSWORD_BCRYPT_DEFAULT_COST;
...
function check() {
    ...
    if (is_null($pass)) {
        if (function_exists('crypt')) {
            $hash = Yii::$app->params->password->checkHash;
