...
class ErexxCollegeRejectionReasons extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['erexx_college_rejection_reasons_enc_id', 'reason_enc_id', 'created_by'], 'required'],
            [['created_on'], 'safe'],
            [['is_deleted'], 'integer'],
            [['erexx_college_rejection_reasons_enc_id', 'reason_enc_id', 'created_by'], 'string', 'max' => 100],
