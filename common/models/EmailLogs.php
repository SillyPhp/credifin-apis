 ...
 * @property int $email_type 1 as Alerts, 2 as Preffered Emails
...
class EmailLogs extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['email_log_enc_id', 'email_type', 'user_enc_id', 'subject', 'template', 'created_by'], 'required'],
            [['email_type'], 'integer'],
            [['created_on', 'last_updated_on'], 'safe'],
            [['email_log_enc_id', 'user_enc_id', 'organization_enc_id', 'template', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
