 ...
 * @property int $subscription_for 0 as All, 1 for Courses
...
class Subscribers extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['subscription_for', 'is_verified'], 'integer'],
            [['subscriber_enc_id'], 'string', 'max' => 100],
            [['first_name', 'last_name'], 'string', 'max' => 30],
            [['email'], 'string', 'max' => 50],
            [['subscriber_enc_id'], 'unique'],
            [['email', 'subscription_for'], 'unique', 'targetAttribute' => ['email', 'subscription_for']],
        ];
    }
}
