...
class AssignedDisbursementCharges extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['assigned_disbursement_charges_enc_id', 'disbursement_charges_enc_id', 'loan_app_enc_id', 'amount', 'created_on', 'created_by', 'updated_on', 'updated_by'], 'required'],
            [['amount'], 'number'],
            [['created_on', 'updated_on'], 'safe'],
            [['is_deleted'], 'integer'],
            [['assigned_disbursement_charges_enc_id', 'disbursement_charges_enc_id', 'loan_app_enc_id', 'created_by', 'updated_by'], 'string', 'max' => 100],
