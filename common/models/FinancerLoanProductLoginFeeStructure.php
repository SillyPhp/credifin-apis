 ...
 * @property string $financer_loan_product_login_fee_structure_enc_id Product enc id
...
class FinancerLoanProductLoginFeeStructure extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['financer_loan_product_no_dues_enc_id', 'financer_loan_product_login_fee_structure_enc_id', 'name', 'amount', 'created_by'], 'required'],
            [['amount'], 'number'],
            [['created_on', 'updated_on'], 'safe'],
            [['is_deleted'], 'integer'],
            [['financer_loan_product_no_dues_enc_id', 'financer_loan_product_login_fee_structure_enc_id', 'created_by', 'updated_by'], 'string', 'max' => 100],
            [['name'], 'string', 'max' => 50],
