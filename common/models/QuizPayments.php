...
/**
 * This is the model class for table "{{%quiz_payments}}".
 *
 * @property int $id random id
 * @property string $payment_enc_id payment encrypted id
 * @property string $quiz_enc_id quiz enc id
 ...
 * @property QuizRegistration $registrationEnc
 * @property Users $updatedBy
 */
class QuizPayments extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['payment_enc_id', 'quiz_enc_id', 'registration_enc_id', 'payment_token', 'payment_amount', 'created_by'], 'required'],
            [['payment_amount', 'payment_gst'], 'number'],
            [['payment_mode'], 'integer'],
            [['created_on', 'updated_on'], 'safe'],
            [['payment_enc_id', 'quiz_enc_id', 'registration_enc_id', 'payment_token', 'payment_id', 'payment_status', 'created_by', 'updated_by'], 'string', 'max' => 100],
            ...
            [['registration_enc_id'], 'exist', 'skipOnError' => true, 'targetClass' => QuizRegistration::className(), 'targetAttribute' => ['registration_enc_id' => 'register_enc_id']],
    ...
    {
        return $this->hasOne(QuizRegistration::className(), ['register_enc_id' => 'registration_enc_id']);
    }
