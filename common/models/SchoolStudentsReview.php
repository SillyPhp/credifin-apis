...
/**
 * This is the model class for table "{{%school_students_review}}".
 *
 * @property int $id Primary Key
 * @property string $school_student_review_enc_id Organization Review Encrypted ID
 ...
 * @property int $school_infrastructure
 ...
 */
class SchoolStudentsReview extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['school_student_review_enc_id', 'average_rating', 'student_engagement', 'school_infrastructure', 'faculty', 'value_for_money', 'teaching_style', 'coverage_of_subject_matter', 'accessibility_of_faculty', 'city_enc_id', 'likes', 'dislikes', 'from_date', 'created_by'], 'required'],
            [['average_rating'], 'number'],
            [['is_current_employee', 'student_engagement', 'school_infrastructure', 'faculty', 'value_for_money', 'teaching_style', 'coverage_of_subject_matter', 'accessibility_of_faculty', 'show_user_details', 'status', 'is_deleted'], 'integer'],
            [['likes', 'dislikes'], 'string'],
            [['from_date', 'to_date', 'created_on', 'last_updated_on'], 'safe'],
            [['school_student_review_enc_id', 'review_enc_id', 'city_enc_id', 'educational_stream_enc_id', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
            [['school_student_review_enc_id'], 'unique'],
