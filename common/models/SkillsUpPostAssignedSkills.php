...
/**
 * This is the model class for table "{{%skills_up_post_assigned_skills}}".
 *
 * @property int $id Primary Key
 * @property string $assigned_skill_enc_id Post Encrypted ID
 ...
 */
class SkillsUpPostAssignedSkills extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%skills_up_post_assigned_skills}}';
    }
    ...
    {
        return [
            [['assigned_skill_enc_id', 'skill_enc_id', 'post_enc_id', 'created_by'], 'required'],
            [['created_on', 'last_updated_on'], 'safe'],
            [['assigned_skill_enc_id', 'skill_enc_id', 'post_enc_id', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
