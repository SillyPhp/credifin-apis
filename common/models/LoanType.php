 ...
 *
 * @property AssignedFinancerLoanTypess[] $assignedFinancerLoanTypes
...
class LoanType extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(AssignedFinancerLoanTypess::className(), ['loan_type_enc_id' => 'loan_type_enc_id']);
    }
