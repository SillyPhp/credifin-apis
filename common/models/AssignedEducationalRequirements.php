 ...
 * @property string $last_updated_by By which User Assigned Educational Requirement information was updated
 * @property string $status Assigned Educational Requirement Status (Approved, Pending)
 * @property int $is_deleted Is Assigned Educational Requirement Deleted (0 As False, 1 As True)
 *
