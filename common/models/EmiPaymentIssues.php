 ...
 * @property int $reasons     1 is legal, 2 is Repo, 3 is accidental, 4 is health
...
class EmiPaymentIssues extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['emi_payment_issues_enc_id', 'loan_account_enc_id', 'loan_app_enc_id', 'created_by', 'updated_by'], 'string', 'max' => 100],
