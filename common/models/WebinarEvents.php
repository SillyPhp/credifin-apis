...
class WebinarEvents extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['event_enc_id', 'webinar_enc_id', 'start_datetime', 'duration', 'created_by'], 'required'],
            [['start_datetime', 'created_on', 'last_updated_on'], 'safe'],
            [['duration', 'status', 'is_deleted'], 'integer'],
            [['description'], 'string'],
            [['event_enc_id', 'webinar_enc_id', 'image', 'image_location', 'created_by', 'last_updated_by'], 'string', 'max' => 100],
