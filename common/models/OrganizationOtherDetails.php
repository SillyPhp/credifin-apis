...
class OrganizationOtherDetails extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['updated_on'], 'safe'],
            [['organization_other_details_enc_id', 'organization_enc_id', 'location_enc_id', 'affiliated_to', 'accredited_to', 'entrance_exam', 'popular_course', 'top_recruiter', 'brochure'], 'string', 'max' => 100],
