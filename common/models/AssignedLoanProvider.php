...
class AssignedLoanProvider extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['assigned_loan_provider_enc_id', 'loan_application_enc_id', 'institute_lead_enc_id', 'provider_enc_id', 'scheme_enc_id', 'assigned_lender_service_enc_id', 'branch_enc_id', 'created_by', 'updated_by', 'loan_status_updated_on'], 'string', 'max' => 100],
