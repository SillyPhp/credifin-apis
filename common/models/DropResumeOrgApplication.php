...
/**
 * This is the model class for table "{{%drop_resume_org_application}}".
 *
 ...
 */
class DropResumeOrgApplication extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return '{{%drop_resume_org_application}}';
    }
