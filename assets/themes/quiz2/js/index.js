(function () {
    ...
    var answer = {
        ...
        updateContent: function (answers) {
            ...
            answers.forEach((element, index, arr) => {
                answer.populate(element, index, arr);
            });
        },
    ...
    var screen = {
        ...
        <!--<div class="another-quizes">-->
            <!--<ul>-->
                <!--<li><a class="elem-button-ends-screen"> vol-1<img-->
                            <!--src="http://ajay.eygb.me/assets/themes/ey/images/pages/quiz/quiz-vol2.jpg" /></a></li>-->
                <!--<li><a class="elem-button-ends-screen"> vol-2 <img-->
                            <!--src="http://ajay.eygb.me/assets/themes/ey/images/pages/quiz/vol_1.png" /></a></li>-->
                <!--<li><a class="elem-button-ends-screen"> vol-3<img-->
                            <!--src="http://ajay.eygb.me/assets/themes/ey/images/pages/quiz/quiz-vol2.jpg" /></a></li>-->
            <!--</ul>-->
            <!--<h4>Play another quizes</h4>-->
        <!--</div>-->
        `);
            $('#elem-button-review-answers').on('click', function () {
                screen.reviewAnswers();
            });
        ...
        <button id="elem-button-back-to-finish" class="elem-button-back">
          &larr; ${uiLabels.main.general.back}
            ...
            $('#elem-button-back-to-finish').on('click', function () {
                screen.end();
            });
            elemAnswersContainer.html(`
    ...
    $(document).on('click', '.another-quizes', function () {
        $(this).toggleClass('aq-open');
    });
}());