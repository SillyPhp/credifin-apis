...
function displayStats(stats) {
    ...
    setTimeout(() => {
        ...
        document.querySelector('#wa-share').href = "https://wa.me/?text=" + window.location.href + "/" + path[1] + "/" + path[2] + "/" + stats.correct + "/" + stats.questionsAsked;
        document.querySelector('#wa-share-mob').href = "whatsapp://send?text=" + window.location.href + "/" + path[1] + "/" + path[2] + "/" + stats.correct + "/" + stats.questionsAsked;
